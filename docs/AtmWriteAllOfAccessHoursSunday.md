# Yext::AtmWriteAllOfAccessHoursSunday

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **is_closed** | **Boolean** | Indicates if the access hours are \&quot;closed\&quot; on Sunday. | [optional] |
...
instance = Yext::AtmWriteAllOfAccessHoursSunday.new(
  is_closed: null,
  open_intervals: null
)
```
