# Yext::AtmWriteAllOfHoursFriday

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **is_closed** | **Boolean** | Indicates if the hours of operation are \&quot;closed\&quot; on Friday. | [optional] |
...
instance = Yext::AtmWriteAllOfHoursFriday.new(
  is_closed: null,
  open_intervals: null
)
```
