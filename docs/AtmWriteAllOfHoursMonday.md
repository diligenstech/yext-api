# Yext::AtmWriteAllOfHoursMonday

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **is_closed** | **Boolean** | Indicates if the hours of operation are \&quot;closed\&quot; on Monday. | [optional] |
...
instance = Yext::AtmWriteAllOfHoursMonday.new(
  is_closed: null,
  open_intervals: null
)
```
