# Yext::HealthcareProfessionalWrite
...
| **admitting_hospitals** | **Array&lt;String&gt;** | A list of hospitals where the healthcare professional admits patients   Array must be ordered.  Array may have a maximum of 100 elements.  Array item description:  &gt;Cannot Include: &gt;* HTML markup | [optional] |
...
| **education_list** | [**Array&lt;HealthcareProfessionalWriteAllOfEducationList&gt;**](HealthcareProfessionalWriteAllOfEducationList.md) | Information about the education or training completed by the healthcare professional   Array must be ordered.  | [optional] |
...
instance = Yext::HealthcareProfessionalWrite.new(
  meta: null,
  name: null,
  address: null,
