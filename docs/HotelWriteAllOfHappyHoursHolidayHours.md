# Yext::HotelWriteAllOfHappyHoursHolidayHours
...
| **is_closed** | **Boolean** | Indicates if the happy hours are \&quot;closed\&quot; on on the given date. | [optional] |
...
| **open_intervals** | [**Array&lt;AtmWriteAllOfAccessHoursFridayOpenIntervals&gt;**](AtmWriteAllOfAccessHoursFridayOpenIntervals.md) | Contains the time intervals for the Entity&#39;s happy hours on the specified date. | [optional] |
...
instance = Yext::HotelWriteAllOfHappyHoursHolidayHours.new(
  date: null,
  is_closed: null,
