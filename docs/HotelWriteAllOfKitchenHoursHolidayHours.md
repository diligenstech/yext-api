# Yext::HotelWriteAllOfKitchenHoursHolidayHours
...
| **is_closed** | **Boolean** | Indicates if the kitchen hours are \&quot;closed\&quot; on on the given date. | [optional] |
...
| **open_intervals** | [**Array&lt;AtmWriteAllOfAccessHoursFridayOpenIntervals&gt;**](AtmWriteAllOfAccessHoursFridayOpenIntervals.md) | Contains the time intervals for which the Entity&#39;s kitchen is open on the specified date. | [optional] |
...
instance = Yext::HotelWriteAllOfKitchenHoursHolidayHours.new(
  date: null,
  is_closed: null,
