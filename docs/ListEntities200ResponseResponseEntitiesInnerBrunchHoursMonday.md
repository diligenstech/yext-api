# Yext::ListEntities200ResponseResponseEntitiesInnerBrunchHoursMonday
...
instance = Yext::ListEntities200ResponseResponseEntitiesInnerBrunchHoursMonday.new(
  is_closed: null,
  open_intervals: null
)
```
