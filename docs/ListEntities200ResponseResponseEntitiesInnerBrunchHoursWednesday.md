# Yext::ListEntities200ResponseResponseEntitiesInnerBrunchHoursWednesday
...
instance = Yext::ListEntities200ResponseResponseEntitiesInnerBrunchHoursWednesday.new(
  is_closed: null,
  open_intervals: null
)
```
