# Yext::ListEntities200ResponseResponseEntitiesInnerDeliveryHoursThursday
...
instance = Yext::ListEntities200ResponseResponseEntitiesInnerDeliveryHoursThursday.new(
  is_closed: null,
  open_intervals: null
)
```
