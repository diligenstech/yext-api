# Yext::ListEntities200ResponseResponseEntitiesInnerDriveThroughHoursMonday
...
instance = Yext::ListEntities200ResponseResponseEntitiesInnerDriveThroughHoursMonday.new(
  is_closed: null,
  open_intervals: null
)
```
