# Yext::ListEntities200ResponseResponseEntitiesInnerOnlineServiceHoursMonday
...
instance = Yext::ListEntities200ResponseResponseEntitiesInnerOnlineServiceHoursMonday.new(
  is_closed: null,
  open_intervals: null
)
```
