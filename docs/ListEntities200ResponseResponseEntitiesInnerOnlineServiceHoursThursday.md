# Yext::ListEntities200ResponseResponseEntitiesInnerOnlineServiceHoursThursday
...
instance = Yext::ListEntities200ResponseResponseEntitiesInnerOnlineServiceHoursThursday.new(
  is_closed: null,
  open_intervals: null
)
```
