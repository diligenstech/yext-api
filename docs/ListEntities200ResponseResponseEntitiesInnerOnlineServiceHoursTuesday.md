# Yext::ListEntities200ResponseResponseEntitiesInnerOnlineServiceHoursTuesday
...
instance = Yext::ListEntities200ResponseResponseEntitiesInnerOnlineServiceHoursTuesday.new(
  is_closed: null,
  open_intervals: null
)
```
