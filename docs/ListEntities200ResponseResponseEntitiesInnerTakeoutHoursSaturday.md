# Yext::ListEntities200ResponseResponseEntitiesInnerTakeoutHoursSaturday
...
instance = Yext::ListEntities200ResponseResponseEntitiesInnerTakeoutHoursSaturday.new(
  is_closed: null,
  open_intervals: null
)
```
