# Yext::LocationWriteAllOfDeliveryHoursHolidayHours
...
| **is_closed** | **Boolean** | Indicates if the delivery hours are \&quot;closed\&quot; on on the given date. | [optional] |
...
| **open_intervals** | [**Array&lt;AtmWriteAllOfAccessHoursFridayOpenIntervals&gt;**](AtmWriteAllOfAccessHoursFridayOpenIntervals.md) | Contains the time intervals for which the Entity is delivering on the specified date. | [optional] |
...
instance = Yext::LocationWriteAllOfDeliveryHoursHolidayHours.new(
  date: null,
  is_closed: null,
