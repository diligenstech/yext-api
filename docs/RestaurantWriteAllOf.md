...
| **accepts_reservations** | **Boolean** | Indicates whether the entity accepts reservations. | [optional] |
...
| **attire** | **String** | The formality of clothing typically worn at this restaurant | [optional] |
...
| **delivery_hours** | [**LocationWriteAllOfDeliveryHours**](LocationWriteAllOfDeliveryHours.md) |  | [optional] |
...
| **meals_served** | **Array&lt;String&gt;** | Types of meals served at this restaurant | [optional] |
...
instance = Yext::RestaurantWriteAllOf.new(
  meta: null,
  name: null,
  address: null,
