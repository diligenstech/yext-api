...
require 'yext/models/entity_access_hours_friday_open_intervals'
require 'yext/models/entity_access_hours_holiday_hours'
...
require 'yext/models/entity_brunch_hours_holiday_hours'
...
require 'yext/models/entity_delivery_hours_holiday_hours'
...
require 'yext/models/entity_drive_through_hours_holiday_hours'
...
require 'yext/models/entity_education_list'
...
require 'yext/models/entity_frequently_asked_questions'
...
require 'yext/models/entity_happy_hours_holiday_hours'
...
require 'yext/models/entity_hours_holiday_hours'
...
require 'yext/models/entity_online_service_hours_holiday_hours'
...
require 'yext/models/entity_photo_gallery'
...
require 'yext/models/entity_pickup_hours_holiday_hours'
...
require 'yext/models/entity_rank_tracking_competitors'
...
require 'yext/models/entity_senior_hours_holiday_hours'
...
require 'yext/models/entity_service_area_places'
require 'yext/models/entity_takeout_hours'
require 'yext/models/entity_takeout_hours_friday'
require 'yext/models/entity_takeout_hours_holiday_hours'
...
require 'yext/models/entity_video'
require 'yext/models/entity_videos'
...
require 'yext/models/hotel_write_all_of_access_hours'
...
require 'yext/models/hotel_write_all_of_hours'
...
require 'yext/models/hotel_write_all_of_service_area'
...
require 'yext/models/location_write_all_of_drive_through_hours'
require 'yext/models/location_write_all_of_online_service_hours'
require 'yext/models/location_write_all_of_pickup_hours'
