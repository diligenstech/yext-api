...
module Yext
  class CreateReportRequestBody
    ...
    # Determines how the data will be grouped. Specify up to 10 values. <br><br> **NOTES:** <br> You can only use one time-based dimension (e.g., `DAYS`, `WEEKS`) per report. <br> You can only use one location-based dimension (e.g., `FOLDER_IDS`, `LOCATION_NAMES`) per report. <br><br> 
