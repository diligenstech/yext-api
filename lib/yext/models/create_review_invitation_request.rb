...
module Yext
  class CreateReviewInvitationRequest
    ...
    # The names of the Review Labels which will be attached to the resulting review.  This is an upsert operation, meaning the system will determine if a Review Label exists already in your account, and create and append a new label if not.  The **`reviewLabelNames`** parameter will only be respected with the inclusion of a **`v`** parameter of `20210728` or later. 
    attr_accessor :review_label_names
    ...
    def self.attribute_map
      {
        ...
        :'review_label_names' => :'reviewLabelNames'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'review_label_names' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Yext::CreateReviewInvitationRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Yext::CreateReviewInvitationRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'review_label_names')
        if (value = attributes[:'review_label_names']).is_a?(Array)
          self.review_label_names = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          review_label_names == o.review_label_names
    end
    ...
    def hash
      [invitation_uid, entity, first_name, last_name, title, contact, include_image, template_id, transaction_id, status, details, language, additional_url_parameters, send_invitation_from_yext, feedback_url, review_labels, review_label_names].hash
    end
