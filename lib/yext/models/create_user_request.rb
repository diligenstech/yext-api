...
module Yext
  class CreateUserRequest
    ...
    def hash
      [id, first_name, last_name, email_address, phone_number, email_language_preference, display_language_preference, last_login_date, sso, acl, password, username].hash
    end
