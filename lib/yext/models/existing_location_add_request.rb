...
module Yext
  class ExistingLocationAddRequest
    ...
    attr_accessor :existing_location_account_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Yext::ExistingLocationAddRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Yext::ExistingLocationAddRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'existing_location_account_id')
        self.existing_location_account_id = attributes[:'existing_location_account_id']
      end
    ...
    def list_invalid_properties
      ...
      if @existing_location_id.nil?
        invalid_properties.push('invalid value for "existing_location_id", existing_location_id cannot be nil.')
      end
    ...
    def valid?
      return false if @existing_location_id.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          existing_location_account_id == o.existing_location_account_id &&
          skus == o.skus &&
    ...
    def hash
      [existing_location_id, existing_location_account_id, skus, agreement_id, force_review].hash
    end
