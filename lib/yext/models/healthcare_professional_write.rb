...
module Yext
  class HealthcareProfessionalWrite < EntityWrite
    attr_accessor :meta
    ...
    # A list of hospitals where the healthcare professional admits patients   Array must be ordered.  Array may have a maximum of 100 elements.  Array item description:  >Cannot Include: >* HTML markup
    ...
    # A list of the certifications held by the healthcare professional **NOTE:** This field is only available to locations whose **`entityType`** is `healthcareProfessional`.    Array must be ordered.  Array may have a maximum of 100 elements.  Array item description:  >Cannot Include: >* HTML markup
    ...
    # A list of the degrees earned by the healthcare professional   Array must be ordered. 
    ...
    # Information about the education or training completed by the healthcare professional   Array must be ordered. 
    ...
    # The first name of the healthcare professional   Cannot Include: * a URL or domain name * HTML markup
    ...
    # The last name of the healthcare professional   Cannot Include: * a URL or domain name * HTML markup
    ...
    # The middle name of the healthcare professional   Cannot Include: * a URL or domain name * HTML markup
    ...
    def self.openapi_types
      {
        ...
        :'education_list' => :'Array<HealthcareProfessionalWriteAllOfEducationList>',
        :'emails' => :'Array<String>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Yext::HealthcareProfessionalWrite` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Yext::HealthcareProfessionalWrite`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
