...
module Yext
  class InlineResponse200ResponseEntities
    attr_accessor :meta
    ...
    # Google My Business Labels help users organize their locations into groups within GMB.   Array must be ordered.  Array may have a maximum of 10 elements.  Array item description:  >Cannot Include: >* HTML markup  Filtering Type: `list of text`  ``` Eligible For:     * atm    * financialProfessional    * healthcareFacility    * healthcareProfessional    * hotel    * location    * restaurant ```
    ...
    #  **NOTE:** The list of photos that you send us must be comprehensive. For example, if you send us a list of photos that does not include photos that you sent in your last update, Yext considers the missing photos to be deleted, and we remove them from your listings.    Array must be ordered.  Array may have a maximum of 100 elements.  Array item description:  >Supported Aspect Ratios: >* 1 x 1 >* 4 x 3 >* 3 x 2 >* 5 x 3 >* 16 x 9 >* 3 x 1 >* 2 x 3 >* 5 x 7 >* 4 x 5 >* 4 x 1 > >**NOTE**: Maximum image size is 5mb after normalization and padding (if applicable). As well, there is a 6 second download limit from the image host. >  Filtering Type: `list of object`  ``` Eligible For:     * event    * financialProfessional    * healthcareFacility    * healthcareProfessional    * hotel    * location    * product    * restaurant ```
    ...
    def self.openapi_types
      {
        ...
        :'access_hours' => :'InlineResponse200ResponseAccessHours',
        ...
        :'adult_pool' => :'String',
        :'age_range' => :'InlineResponse200ResponseAgeRange',
        ...
        :'brands' => :'Array<String>',
        :'breakfast' => :'String',
        :'brunch_hours' => :'InlineResponse200ResponseBrunchHours',
        ...
        :'delivery_hours' => :'InlineResponse200ResponseDeliveryHours',
        :'description' => :'String',
        :'display_coordinate' => :'InlineResponse200ResponseDisplayCoordinate',
        :'doctor_on_call' => :'String',
        :'dogs_allowed' => :'String',
        :'drive_through_hours' => :'InlineResponse200ResponseDriveThroughHours',
        :'dropoff_coordinate' => :'InlineResponse200ResponseDropoffCoordinate',
        :'education_list' => :'Array<InlineResponse200ResponseEducationList>',
        ...
        :'event_status' => :'String',
        :'facebook_call_to_action' => :'InlineResponse200ResponseFacebookCallToAction',
        :'facebook_cover_photo' => :'InlineResponse200ResponseFacebookCoverPhoto',
        :'facebook_descriptor' => :'String',
        :'facebook_name' => :'String',
        :'facebook_override_city' => :'String',
        :'facebook_page_url' => :'String',
        :'facebook_profile_photo' => :'InlineResponse200ResponseFacebookProfilePhoto',
        :'facebook_vanity_url' => :'String',
        :'fax' => :'String',
        :'featured_message' => :'InlineResponse200ResponseFeaturedMessage',
        :'first_name' => :'String',
        ...
        :'google_cover_photo' => :'InlineResponse200ResponseGoogleCoverPhoto',
        :'google_my_business_labels' => :'Array<String>',
        :'google_place_id' => :'String',
        :'google_profile_photo' => :'InlineResponse200ResponseGoogleProfilePhoto',
        :'google_website_override' => :'String',
        :'happy_hours' => :'InlineResponse200ResponseHappyHours',
        ...
        :'kitchen_hours' => :'InlineResponse200ResponseKitchenHours',
        :'labels' => :'Array<String>',
        ...
        :'menu_url' => :'InlineResponse200ResponseMenuUrl',
        ...
        :'office_name' => :'String',
        :'online_service_hours' => :'InlineResponse200ResponseOnlineServiceHours',
        :'order_url' => :'InlineResponse200ResponseOrderUrl',
        ...
        :'pets_allowed' => :'String',
        :'photo_gallery' => :'Array<InlineResponse200ResponsePhotoGallery>',
        :'pickup_coordinate' => :'InlineResponse200ResponsePickupCoordinate',
        :'pickup_hours' => :'InlineResponse200ResponsePickupHours',
        :'price_range' => :'String',
        :'primary_conversation_contact' => :'String',
        :'private_beach' => :'String',
        :'private_car_service' => :'String',
        :'product_lists' => :'InlineResponse200ResponseProductLists',
        ...
        :'reservation_url' => :'InlineResponse200ResponseReservationUrl',
        :'restaurant_count' => :'Float',
        :'review_generation_url' => :'String',
        :'review_response_conversation_enabled' => :'Boolean',
        :'room_count' => :'Float',
        :'room_service' => :'String',
        :'routable_coordinate' => :'InlineResponse200ResponseRoutableCoordinate',
        :'salon' => :'String',
        :'sauna' => :'String',
        :'scuba' => :'String',
        :'self_parking' => :'String',
        :'senior_hours' => :'InlineResponse200ResponseSeniorHours',
        :'service_area' => :'InlineResponse200ResponseServiceArea',
        :'service_area_places' => :'Array<InlineResponse200ResponseServiceAreaPlaces>',
        ...
        :'takeout_hours' => :'InlineResponse200ResponseTakeoutHours',
        :'tennis' => :'String',
        :'thermal_pool' => :'String',
        :'ticket_availability' => :'String',
        :'ticket_price_range' => :'InlineResponse200ResponseTicketPriceRange',
        ...
        :'uber_link' => :'InlineResponse200ResponseUberLink',
        :'uber_trip_branding' => :'InlineResponse200ResponseUberTripBranding',
        ...
        :'walkable_coordinate' => :'InlineResponse200ResponseWalkableCoordinate',
        :'water_park' => :'String',
        :'water_skiing' => :'String',
        :'watercraft' => :'String',
        :'waterslide' => :'String',
        :'wave_pool' => :'String',
        :'website_url' => :'InlineResponse200ResponseWebsiteUrl',
        ...
        :'yext_display_coordinate' => :'InlineResponse200ResponseYextDisplayCoordinate',
        :'yext_dropoff_coordinate' => :'InlineResponse200ResponseYextDropoffCoordinate',
        :'yext_pickup_coordinate' => :'InlineResponse200ResponseYextPickupCoordinate',
        :'yext_routable_coordinate' => :'InlineResponse200ResponseYextRoutableCoordinate',
        :'yext_walkable_coordinate' => :'InlineResponse200ResponseYextWalkableCoordinate'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Yext::InlineResponse200ResponseEntities` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Yext::InlineResponse200ResponseEntities`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
