...
module Yext
  ...
  class ListEntities200ResponseResponseEntitiesInnerAddress
    ...
    # The entity's postal code. The postal code must be valid for the entity's country. Cannot include a URL or domain name.   Cannot Include: * a URL or domain name  Filtering Type: `text`
    attr_accessor :postal_code

    # The name of the entity's region or state.   Cannot Include: * a URL or domain name  Filtering Type: `text`
    attr_accessor :region

    # The name of the entity's sublocality   Cannot Include: * a URL or domain name  Filtering Type: `text`
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Yext::ListEntities200ResponseResponseEntitiesInnerAddress` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Yext::ListEntities200ResponseResponseEntitiesInnerAddress`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@extra_description.nil? && @extra_description.to_s.length > 255
        invalid_properties.push('invalid value for "extra_description", the character length must be smaller than or equal to 255.')
      end

      if !@extra_description.nil? && @extra_description.to_s.length < 0
        invalid_properties.push('invalid value for "extra_description", the character length must be great than or equal to 0.')
      end

      if !@line1.nil? && @line1.to_s.length > 255
      ...
      if !@sublocality.nil? && @sublocality.to_s.length < 0
        invalid_properties.push('invalid value for "sublocality", the character length must be great than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if !@extra_description.nil? && @extra_description.to_s.length > 255
      return false if !@extra_description.nil? && @extra_description.to_s.length < 0
      return false if !@line1.nil? && @line1.to_s.length > 255
      ...
      return false if !@sublocality.nil? && @sublocality.to_s.length < 0
      true
    end
    ...
    def extra_description=(extra_description)
      if !extra_description.nil? && extra_description.to_s.length > 255
        fail ArgumentError, 'invalid value for "extra_description", the character length must be smaller than or equal to 255.'
      end

      if !extra_description.nil? && extra_description.to_s.length < 0
        fail ArgumentError, 'invalid value for "extra_description", the character length must be great than or equal to 0.'
      end
    ...
    def sublocality=(sublocality)
      ...
      if !sublocality.nil? && sublocality.to_s.length < 0
        fail ArgumentError, 'invalid value for "sublocality", the character length must be great than or equal to 0.'
      end
    ...
    def hash
      [city, country_code, extra_description, line1, line2, line3, postal_code, region, sublocality].hash
    end
