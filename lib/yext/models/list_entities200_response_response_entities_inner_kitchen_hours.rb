...
module Yext
  ...
  class ListEntities200ResponseResponseEntitiesInnerKitchenHours
    ...
    def self.openapi_types
      {
        :'friday' => :'ListEntities200ResponseResponseEntitiesInnerKitchenHoursFriday',
        :'holiday_hours' => :'Array<ListEntities200ResponseResponseEntitiesInnerKitchenHoursHolidayHoursInner>',
        :'monday' => :'ListEntities200ResponseResponseEntitiesInnerKitchenHoursMonday',
        :'reopen_date' => :'Date',
        :'saturday' => :'ListEntities200ResponseResponseEntitiesInnerKitchenHoursSaturday',
        :'sunday' => :'ListEntities200ResponseResponseEntitiesInnerKitchenHoursSunday',
        :'thursday' => :'ListEntities200ResponseResponseEntitiesInnerKitchenHoursThursday',
        :'tuesday' => :'ListEntities200ResponseResponseEntitiesInnerKitchenHoursTuesday',
        :'wednesday' => :'ListEntities200ResponseResponseEntitiesInnerKitchenHoursWednesday'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Yext::ListEntities200ResponseResponseEntitiesInnerKitchenHours` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Yext::ListEntities200ResponseResponseEntitiesInnerKitchenHours`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
