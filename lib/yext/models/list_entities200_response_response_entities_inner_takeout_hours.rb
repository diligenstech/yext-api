...
module Yext
  ...
  class ListEntities200ResponseResponseEntitiesInnerTakeoutHours
    ...
    def self.openapi_types
      {
        :'friday' => :'ListEntities200ResponseResponseEntitiesInnerTakeoutHoursFriday',
        :'holiday_hours' => :'Array<ListEntities200ResponseResponseEntitiesInnerTakeoutHoursHolidayHoursInner>',
        :'monday' => :'ListEntities200ResponseResponseEntitiesInnerTakeoutHoursMonday',
        :'reopen_date' => :'Date',
        :'saturday' => :'ListEntities200ResponseResponseEntitiesInnerTakeoutHoursSaturday',
        :'sunday' => :'ListEntities200ResponseResponseEntitiesInnerTakeoutHoursSunday',
        :'thursday' => :'ListEntities200ResponseResponseEntitiesInnerTakeoutHoursThursday',
        :'tuesday' => :'ListEntities200ResponseResponseEntitiesInnerTakeoutHoursTuesday',
        :'wednesday' => :'ListEntities200ResponseResponseEntitiesInnerTakeoutHoursWednesday'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Yext::ListEntities200ResponseResponseEntitiesInnerTakeoutHours` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Yext::ListEntities200ResponseResponseEntitiesInnerTakeoutHours`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
