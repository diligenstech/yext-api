  ...
  class Location
    ...
    def self.openapi_types
      {
        ...
        :'google_cover_photo' => :'Photo',
        :'google_profile_photo' => :'Photo',
        :'google_attributes' => :'Array<LocationGoogleAttributes>',
        :'facebook_page_url' => :'String',
        :'facebook_call_to_action' => :'LocationFacebookCallToAction',
        :'facebook_cover_photo' => :'Photo',
        :'facebook_profile_picture' => :'Photo',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'headshot')
        if (value = attributes[:'headshot']).is_a?(Hash)
          self.headshot = value
        end
      ...
      if attributes.key?(:'google_cover_photo')
        if (value = attributes[:'google_cover_photo']).is_a?(Hash)
          self.google_cover_photo = value
        end
        self.google_cover_photo = attributes[:'google_cover_photo']
      end

      if attributes.key?(:'google_profile_photo')
        if (value = attributes[:'google_profile_photo']).is_a?(Hash)
          self.google_profile_photo = value
        end
      ...
      if attributes.key?(:'facebook_cover_photo')
        if (value = attributes[:'facebook_cover_photo']).is_a?(Hash)
          self.facebook_cover_photo = value
        end
        self.facebook_cover_photo = attributes[:'facebook_cover_photo']
      end

      if attributes.key?(:'facebook_profile_picture')
        if (value = attributes[:'facebook_profile_picture']).is_a?(Hash)
          self.facebook_profile_picture = value
        end
