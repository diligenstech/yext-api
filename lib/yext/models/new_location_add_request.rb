...
module Yext
  class NewLocationAddRequest
    ...
    def self.openapi_types
      {
        ...
        :'new_location_data' => :'NewLocationAddRequestNewLocationData',
    ...
    def list_invalid_properties
      ...
      if @new_location_data.nil?
        invalid_properties.push('invalid value for "new_location_data", new_location_data cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @new_location_data.nil?
