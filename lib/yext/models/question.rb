...
module Yext
  class Question
    ...
    attr_accessor :author_photo_url
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Yext::Question` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Yext::Question`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'author_photo_url')
        self.author_photo_url = attributes[:'author_photo_url']
      end
    ...
    def valid?
      author_type_validator = EnumAttributeValidator.new('String', ["REGULAR_USER", "LOCAL_GUIDE", "MERCHANT", "AUTHOR_TYPE_UNSPECIFIED"])
    ...
    def author_type=(author_type)
      validator = EnumAttributeValidator.new('String', ["REGULAR_USER", "LOCAL_GUIDE", "MERCHANT", "AUTHOR_TYPE_UNSPECIFIED"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          author_photo_url == o.author_photo_url &&
    ...
    def hash
      [id, entity_ids, account_id, publisher_id, author_name, author_email, author_photo_url, author_type, language, upvote_count, content, description, create_time, update_time, answer_count, answers].hash
    end
