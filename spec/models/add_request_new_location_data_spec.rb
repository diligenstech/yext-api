...
# Unit tests for Yext::AddRequestNewLocationData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yext::AddRequestNewLocationData do
  let(:instance) { Yext::AddRequestNewLocationData.new }

  describe 'test an instance of AddRequestNewLocationData' do
    it 'should create an instance of AddRequestNewLocationData' do
      expect(instance).to be_instance_of(Yext::AddRequestNewLocationData)
    end
  end
