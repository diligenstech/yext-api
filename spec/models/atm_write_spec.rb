...
# Unit tests for Yext::AtmWrite
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yext::AtmWrite do
  let(:instance) { Yext::AtmWrite.new }

  describe 'test an instance of AtmWrite' do
    it 'should create an instance of AtmWrite' do
      expect(instance).to be_instance_of(Yext::AtmWrite)
    end
  end
