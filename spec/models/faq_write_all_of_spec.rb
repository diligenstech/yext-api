...
# Unit tests for Yext::FaqWriteAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yext::FaqWriteAllOf do
  let(:instance) { Yext::FaqWriteAllOf.new }

  describe 'test an instance of FaqWriteAllOf' do
    it 'should create an instance of FaqWriteAllOf' do
      expect(instance).to be_instance_of(Yext::FaqWriteAllOf)
    end
  end
