...
# Unit tests for Yext::FaqWrite
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yext::FaqWrite do
  let(:instance) { Yext::FaqWrite.new }

  describe 'test an instance of FaqWrite' do
    it 'should create an instance of FaqWrite' do
      expect(instance).to be_instance_of(Yext::FaqWrite)
    end
  end
