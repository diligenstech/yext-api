...
# Unit tests for Yext::HealthcareFacilityWrite
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yext::HealthcareFacilityWrite do
  let(:instance) { Yext::HealthcareFacilityWrite.new }

  describe 'test an instance of HealthcareFacilityWrite' do
    it 'should create an instance of HealthcareFacilityWrite' do
      expect(instance).to be_instance_of(Yext::HealthcareFacilityWrite)
    end
  end
