...
# Unit tests for Yext::HealthcareProfessionalWrite
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yext::HealthcareProfessionalWrite do
  let(:instance) { Yext::HealthcareProfessionalWrite.new }

  describe 'test an instance of HealthcareProfessionalWrite' do
    it 'should create an instance of HealthcareProfessionalWrite' do
      expect(instance).to be_instance_of(Yext::HealthcareProfessionalWrite)
    end
  end
