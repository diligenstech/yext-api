...
# Unit tests for Yext::LocationWriteAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yext::LocationWriteAllOf do
  let(:instance) { Yext::LocationWriteAllOf.new }

  describe 'test an instance of LocationWriteAllOf' do
    it 'should create an instance of LocationWriteAllOf' do
      expect(instance).to be_instance_of(Yext::LocationWriteAllOf)
    end
  end
