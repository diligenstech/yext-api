...
# Unit tests for Yext::LocationWrite
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yext::LocationWrite do
  let(:instance) { Yext::LocationWrite.new }

  describe 'test an instance of LocationWrite' do
    it 'should create an instance of LocationWrite' do
      expect(instance).to be_instance_of(Yext::LocationWrite)
    end
  end
