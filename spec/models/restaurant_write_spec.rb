...
# Unit tests for Yext::RestaurantWrite
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Yext::RestaurantWrite do
  let(:instance) { Yext::RestaurantWrite.new }

  describe 'test an instance of RestaurantWrite' do
    it 'should create an instance of RestaurantWrite' do
      expect(instance).to be_instance_of(Yext::RestaurantWrite)
    end
  end
